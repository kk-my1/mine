...
parser.add_argument('--dec_lambda',type=float,default=0.3)
def setup_seed(seed):
...
if __name__ == '__main__':
    args = parser.parse_args()
        # Normalize modality and sets to lists if passed as space-separated strings (from runx YAML)
    if isinstance(args.modality, str):
        args.modality = args.modality.split()
    if isinstance(args.sets, str):
        args.sets = args.sets.split()
